...
void WaterEnemyObject::AddSounds(SoundManager* sound_mgr)
{
	entity_sounds.insert(std::pair<std::string, sf::Sound*>("DEATH", sound_mgr->Load("\Deaths/Water Enemy Death.wav")));
}
